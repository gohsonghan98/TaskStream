...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total number of deadlines using streams" + countDeadinesUsingStreams(tasksData));
    }
    ...
    public static int countDeadinesUsingStreams(ArrayList<Task> tasksData){
